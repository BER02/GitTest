 ...
 * Name: Ratul Sarna
 * 
 * This program implements the classic arcade game of
 * Breakout, which was invented by Steve Wozniak.
 * Implements :
 * a) All messages for start, score and end of the game
 * b) Score for the game
 * c) Kicker that increases the difficulty of the game 
...
public class me2 extends GraphicsProgram {
